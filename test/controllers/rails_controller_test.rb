...
class RailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rail" do
    assert_difference('Rail.count') do
      post rails_url, params: { rail: { g: @rail.g, lat: @rail.lat, lng: @rail.lng, map: @rail.map, scaffold: @rail.scaffold, text: @rail.text } }
    end
  ...
  test "should update rail" do
    patch rail_url(@rail), params: { rail: { g: @rail.g, lat: @rail.lat, lng: @rail.lng, map: @rail.map, scaffold: @rail.scaffold, text: @rail.text } }
